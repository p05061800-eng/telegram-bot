...
MSG_PAY_PROOF_RECEIVED = "⏳ Получили скрин. Укажите адрес доставки — админ увидит заказ только после «✅ Отправить заказ»."
MSG_PAY_PROOF_OK = (
...
MSG_POSTPAID_SHIPPING_BY = (
    ...
    "Можно несколькими сообщениями. Когда всё готово — нажмите «✅ Отправить заказ»: "
    "администратор получит полный заказ со скрином оплаты."
)
...
PAY_CARD_BODY = (
    ...
    "Кнопку «✅ Оплатить» нажимать необязательно."
)
PAY_TRANSFER_BODY = (
    "📱 Перевод на номер\n\n"
    "Телефон:\n"
...
async def on_customer_proof_media(
    ...
    try:
        ...
        await msg.reply_text(
            ...
            "затем пришлите скрин. Кнопку «✅ Оплатить» можно не нажимать.",
            reply_markup=REPLY_KB,
        )
    except ApplicationHandlerStop:
        raise
